...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-Harmonics/`**
...
```bash
git subtree push --prefix=BWA-Harmonics git@github.com:vmcguire/BWA-Harmonics.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-Harmonics.vst3`.
